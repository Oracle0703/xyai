...
const UsageFiltersStub = defineComponent({
  ...
  template: '<div data-test="usage-filters" :data-allow-cleanup="String(allowCleanup)"><span data-test="user-filter-label">{{ userKeyword }}</span><slot name="after-reset" /></div>',
})
const UsageTableStub = {
  props: ['columns', 'userClickable'],
  emits: ['userClick'],
