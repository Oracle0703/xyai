...
import enAdminOrganizationUsage from '../locales/en/admin/organizationUsage'
...
import zhAdminOrganizationUsage from '../locales/zh/admin/organizationUsage'
...
const admins: Record<string, Modules> = {
  zh: {
    ...
    organizationUsage: zhAdminOrganizationUsage
  },
  en: {
    ...
    organizationUsage: enAdminOrganizationUsage
  }
}
