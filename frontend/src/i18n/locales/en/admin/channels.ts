export default {
    ...
    riskControl: {
      ...
      promptRisk: {
        ...
        judge: {
          ...
          recursionTitle: 'Prevent self-trigger (important)',
    ...
    subscriptions: {
      ...
      bulkResetDaily: 'Reset All Daily Limits',
      bulkResetDailyTitle: 'Reset Filtered Daily Limits',
      bulkResetDailyConfirm: 'Reset daily usage for every active subscription in the current filtered results across all pages? Weekly and monthly usage will not be changed.',
      bulkResetDailyRunning: 'Resetting...',
      bulkResetDailySuccess: 'Reset daily limits for {count} subscriptions',
      bulkResetDailyNoMatches: 'No active subscriptions match the current filters',
      bulkResetDailyFailed: 'Failed to reset filtered daily limits',
