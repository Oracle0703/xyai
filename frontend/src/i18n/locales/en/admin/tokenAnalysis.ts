export default {
  tokenAnalysis: {
    ...
    usageTrend: 'Billing Usage Trend',
    selectedUsersCount: 'Selected {count}/5',
    selectUserTrend: 'Select usage trend for {email}',
    trendDay: 'Daily',
    trendHour: 'Hourly',
    trendHourSingleDayHint: 'Hourly view is available for a single day only',
    trendLoadFailed: 'Failed to load usage trend',
    trendRetry: 'Retry',
    trendNoUsage: 'No billed usage for the selected users in this range',
