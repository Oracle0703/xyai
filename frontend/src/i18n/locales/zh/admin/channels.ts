export default {
    ...
    subscriptions: {
      ...
      bulkResetDaily: '一键重置日限',
      bulkResetDailyTitle: '重置筛选结果日限',
      bulkResetDailyConfirm: '确定要重置当前筛选结果中所有生效订阅的每日用量吗？该操作覆盖全部分页结果，不会修改周用量和月用量。',
      bulkResetDailyRunning: '重置中...',
      bulkResetDailySuccess: '已重置 {count} 个订阅的日限',
      bulkResetDailyNoMatches: '当前筛选条件下没有可重置的生效订阅',
      bulkResetDailyFailed: '一键重置日限失败',
