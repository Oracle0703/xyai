...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	contentModerationService := service.ProvideContentModerationService(settingRepository, settingService, contentModerationRepository, contentModerationHashCache, groupRepository, userRepository, apiKeyAuthCacheInvalidator, emailService, configConfig)
