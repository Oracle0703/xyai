...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	userConcurrencyPresetRepository := repository.NewUserConcurrencyPresetRepository(db)
	userConcurrencyPresetService := service.ProvideUserConcurrencyPresetService(userConcurrencyPresetRepository, userRepository, apiKeyAuthCacheInvalidator, configConfig)
	userConcurrencyPresetHandler := admin.NewUserConcurrencyPresetHandler(userConcurrencyPresetService)
	...
	organizationUsageRepository := repository.NewOrganizationUsageRepository(db)
	organizationUsageService := service.NewOrganizationUsageService(organizationUsageRepository)
	organizationUsageHandler := admin.NewOrganizationUsageHandler(organizationUsageService)
	...
	requestInterceptRulesService := service.NewRequestInterceptRulesService(settingRepository)
	requestInterceptHandler := admin.NewRequestInterceptHandler(requestInterceptRulesService)
	...
	contentModerationService := service.ProvideContentModerationService(settingRepository, settingService, contentModerationRepository, contentModerationHashCache, groupRepository, userRepository, proxyRepository, apiKeyAuthCacheInvalidator, emailService, configConfig)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, userConcurrencyPresetHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, organizationUsageHandler, tokenAnalysisHandler, userAttributeHandler, errorPassthroughHandler, requestInterceptHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, optionalJWTAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, extension, compositeRouteResolver, redisClient)
	...
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, opsService, opsIngressRejectAggregator, apiKeyService, authCacheInvalidationWorker, schedulerSnapshotService, tokenRefreshService, accountExpiryService, tokenAnalysisService, openAICodexVersionSyncService, proxyExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, batchImageCleanupService, batchImageWorkerRuntime, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, userConcurrencyPresetRunner, backupService, paymentOrderExpiryService, channelMonitorRunner, extension, userPlatformQuotaUsageFlusher, upstreamBillingProbeService, ollamaCloudUsageService, auditLogService, promptService)
