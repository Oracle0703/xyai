...
func (a *LegacyModerationAdapter) Check(ctx context.Context, req Request) (*LegacyDecision, error) {
	...
	decision, err := a.service.Check(ctx, legacyModerationInput(req))
...
func legacyModerationInput(req Request) service.ContentModerationCheckInput {
	return service.ContentModerationCheckInput{
		...
		PromptRiskJudgeHeader: req.PromptRiskJudgeHeader,
	}
}
