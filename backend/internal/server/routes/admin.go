...
func registerTokenAnalysisRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	tokenAnalysis := admin.Group("/token-analysis")
	{
		...
		tokenAnalysis.GET("/projects", h.Admin.TokenAnalysis.Projects)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		// 网关请求归档配置
		adminSettings.GET("/request-archive", h.Admin.Setting.GetRequestArchiveSettings)
		adminSettings.PUT("/request-archive", h.Admin.Setting.UpdateRequestArchiveSettings)
		// 面板 API 限流配置
