...
func RegisterGatewayRoutes(
	...
	r.POST("/responses/*subpath", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, requestArchive, requestIntercept, guardResponsesSubpath(responsesHandler))
