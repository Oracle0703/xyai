...
- 当前集成分支为 `feature/hy/10170_merge_upstream_v170`: 第一父基线固定为本地 `main@12770bc5da8c0ef6a2dd02b0e80a37f6eb26d408`, 第二父待提交边界为 `Wei-Shaw/sub2api main@7e2e9ba05026b7126318aa0754c1afa0ac00bc58`, merge base 为 `5a6143097db142b72a6fc848c214e97214470bdd`, `backend/cmd/server/VERSION` 为 `0.1.170`。合并保持 `MERGE_HEAD` 待用户审核；不要用版本标签或当前 upstream HEAD 替代该精确提交。
