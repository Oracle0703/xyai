...
## 2026-07-17 main sync (v0.1.160; awaiting review)
...
| Merge commit | **待用户审核，尚未创建；`MERGE_HEAD=57914967cbb127ff715719c3879d881c10d75274`** |
...
| Approval / delivery | 最终 staged 门禁为 143 files / `+20209 -118`；`HEAD=main@5d5f157`, `MERGE_HEAD=upstream/main@57914967c`。无 unstaged/untracked/unmerged/marker/features 删除；排除上游 source-freeze patch 后 diff check 退出 0。保持未提交 merge 状态, 不 commit、不 push、不创建 PR、不部署, 等待用户审核。 |
